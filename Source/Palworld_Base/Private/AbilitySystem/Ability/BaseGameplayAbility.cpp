...
UPawnEquipmentComponent* UBaseGameplayAbility::GetPawnEquipmentComponentFromActorInfo() const
{
    return GetAvatarActorFromActorInfo()->FindComponentByClass<UPawnEquipmentComponent>();
}
